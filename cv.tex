...
\begin{center}
  ...
  \vspace{0.3em}
  {\small 求职方向：多模态数据管线 / 大模型数据工程 / 数据中心化基础设施\par}
  \vspace{0.2em}
  \cvmeta{浙江大学计算机博士 \,|\, 上海人工智能实验室 Junior Researcher \,|\, 29 篇论文 / 预印本 \,|\, 920+ Scholar 引用}\par
  \cvmeta{电话：15158155897 \,|\, 邮箱：\href{mailto:zhuyun_dcd@zju.edu.cn}{\nolinkurl{zhuyun_dcd@zju.edu.cn}} \,|\, 个人网站：\url{https://zhuyun97.github.io/} \,|\, Scholar：\href{\scholarurl}{主页链接}}
\end{center}
